...
// @Description Возвращает дату регистрации, количество созданных персонажей/комнат, а также данные самого прокачанного персонажа и самой популярной комнаты.
// @Tags Statistics
// @Produce json
// @Security ApiKeyAuth
